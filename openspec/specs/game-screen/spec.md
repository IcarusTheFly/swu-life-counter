...
The `game-screen` capability defines the in-game life-counter chrome and controls — the divider menu, the initiative indicator, the end-game result prompt's side labeling, and the legibility of all in-game elements over the shared animated space background.

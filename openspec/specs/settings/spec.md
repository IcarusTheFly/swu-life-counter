...
The `settings` capability defines user-configurable preferences for the life counter — team colors per side, life-counting mode (Count Down vs Count Up), and starting life — along with how those preferences are surfaced in the Settings screen, applied to the in-game life counter, clamped, and persisted across app launches.
